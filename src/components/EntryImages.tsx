...
import { ChevronLeft, ChevronRight, X, ZoomIn, Download, Share, ImageIcon, Loader2, Plus } from 'lucide-react'
  ...
  if (images.length === 1) {
    return (
      <div className={cn("relative group", className)}>
        <div className={cn("relative overflow-hidden rounded-lg border border-gold/20", getAspectRatioClass())}>
          {loadingImages.has(0) && (
