...
export function LocationModal({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="bg-parchment shadow-xl rounded-2xl border border-gold/30 w-full max-w-4xl max-h-[90vh] overflow-y-auto p-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    ...
                                    <span className="text-sm text-deepbrown/70">
                                        {locationName}
                                    </span>
                        ...
                        <div className="bg-parchment-light border border-gold/20 rounded-lg p-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Badge
                                        className={`text-xs capitalize ${getStatusColor(trip.status)}`}
                                    >
                                        {trip.status}
                                    </Badge>
                                </div>
                                    ...
                                    {entry.tags && entry.tags.length > 0 && (
                                        <div>
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className="text-sm text-deepbrown/60">
                                                    Tags:
                                                </span>
                                            </div>
