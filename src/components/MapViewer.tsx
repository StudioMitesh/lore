...
import { Search, Layers, Route, Navigation, Satellite, Map as MapIcon, Loader2 } from "lucide-react";
        ...
        for (const [index, location] of sortedLocs.entries()) {
          ...
          if (marker) {
            ...
            pin.addEventListener('mouseenter', () => {
              ...
              `;
              mapService.showInfoWindow(content, { lat: location.lat, lng: location.lng });
            });
              ...
              <Popover>
                ...
                <PopoverContent className="w-56 bg-white/98 backdrop-blur-sm shadow-2xl border-2 border-gray-200 rounded-xl p-4">
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm font-medium text-gray-700 mb-2 block">Map Type</label>
                      <ToggleGroup type="single" value={mapType} onValueChange={setMapType} className="grid grid-cols-2 gap-1">
      ...
      {(locations.length > 0 || trips.length > 0) && (
        ...
        >
          <div className="space-y-3">
            <div className="text-sm font-bold text-gray-800 mb-3 pb-2 border-b border-gray-200">Map Legend</div>
      ...
      <div className="absolute bottom-8 right-8 w-20 h-20 opacity-70 pointer-events-none">
        ...
        >
          <svg width="80" height="80" viewBox="0 0 80 80" className="text-gray-600">
            ...
            <circle cx="40" cy="40" r="35" fill="url(#compassGradient)" stroke="currentColor" strokeWidth="1" opacity="0.5" />
            <path
            ...
            <text x="40" y="12" textAnchor="middle" fontSize="10" fill="currentColor" fontWeight="bold">N</text>
          </svg>
        </motion.div>
      </div>
    </div>
