...
export function ProfileCard({ name, username, avatarUrl, bio, stats, className }: ProfileCardProps) {
  return (
    <Card className={cn("overflow-hidden border-gold/20 bg-parchment-light", className)}>
      ...
      <div className="relative px-6">
        <Avatar className="absolute -top-12 ring-4 ring-parchment w-24 h-24">
          ...
          <AvatarFallback className="text-2xl font-display bg-gold text-white">{name.charAt(0)}</AvatarFallback>
        </Avatar>
      </div>
