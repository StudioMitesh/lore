...
export class MapService {
    ...
    async createPolyline(
        ...
        const { Polyline } = (await window.google.maps.importLibrary(
            'maps'
        )) as unknown as GoogleMapsLibrary;
    ...
    async renderDirections(
        ...
        const { DirectionsRenderer } = (await window.google.maps.importLibrary(
            'routes'
        )) as unknown as GoogleMapsLibrary;
    ...
    async initMarkerClusterer() {
        ...
        const { MarkerClusterer, SuperClusterAlgorithm } = await import(
        ...
        this.markerClusterer = new MarkerClusterer({
          ...
          `;
                    ...
                    clusterMarker.className =
                        'cluster-marker transform transition-all hover:scale-110 cursor-pointer';
    ...
    createTripPin(
        ...
        pin.className =
            'trip-marker relative flex items-center justify-center transform transition-all duration-200 hover:scale-125 cursor-pointer hover:z-50 group';
    ...
    createStandalonePin(color: string, type: 'visited' | 'planned' | 'favorite' = 'visited') {
        const pin = document.createElement('div');
        pin.className =
            'standalone-marker relative flex items-center justify-center transform transition-all duration-200 hover:scale-125 cursor-pointer hover:z-50 group';
