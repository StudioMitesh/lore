                    ...
                    <DialogContent className="max-w-[100vw] w-full max-h-[90vh] bg-parchment border border-gold/20 shadow-2xl overflow-y-auto">
                      <DialogHeader>
                        ...
                        <p className="text-sm text-deepbrown/70 mt-1">
                          Create a custom location marker for places you want to remember or plan to
                          visit
                        </p>
                      </DialogHeader>
                                  ...
                                  <SelectItem key={trip.id} value={trip.id}>
                                    <div className="flex items-center gap-2">
                                      <div
                                        ...
                                        style={{
                                          backgroundColor: getTripColor(trip.status),
                                        }}
                                      ></div>
                                      <span>{trip.name}</span>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                  <div>
                                    ...
                                    <p className="font-mono text-deepbrown">
                                      {newLocation.coordinates.lat.toFixed(6)}
                                    </p>
                                  </div>
                                  <div>
                                    <span className="text-deepbrown/70">Longitude:</span>
                                    <p className="font-mono text-deepbrown">
                                      {newLocation.coordinates.lng.toFixed(6)}
                                    </p>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2">
                            ...
                            <p className="text-xs text-deepbrown/70">
                              Click anywhere on the map to set the exact coordinates for your custom
                              location.
                            </p>
                          </div>
                      ...
                      <DialogFooter className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gold/20">
                        <div className="flex-1 text-left">
                          <p className="text-xs text-deepbrown/70">
                            * Required fields. Custom locations help you organize and remember
                            important places.
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-1 text-xs text-deepbrown/70">
                          ...
                          {location.entry && (
                            <>
                              <span>•</span>
                              <span>
                                {format(new Date(location.entry.timestamp), 'MMM d, yyyy')}
                              </span>
                            </>
                          )}
                        </div>
