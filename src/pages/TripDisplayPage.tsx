                ...
                <div className="container mx-auto px-3 sm:px-6 lg:px-8">
                                ...
                                <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-deepbrown/70">
                                    ...
                                    {trip.totalEntries > 0 && (
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span>
                                                {trip.totalEntries}{' '}
                                                {trip.totalEntries === 1 ? 'entry' : 'entries'}
                                            </span>
                                        </div>
                                    )}
                                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6 sm:gap-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {tripEntries.map((entry, index) => (
                                            <EntryCard
                                                ...
                                                onFavoriteToggle={() =>
                                                    handleEntryFavoriteToggle(entry.id)
                                                }
                                    ...
                                    <Card className="border-gold/20 bg-parchment-light">
                                        <CardContent className="text-center py-8 sm:py-12">
                                            ...
                                            <p className="text-sm sm:text-base text-deepbrown/70 mb-4 sm:mb-6">
                                                Start documenting your adventure by adding your
                                                first entry
                                            </p>
                                            {isOwner && (
                                                <AnimatedButton
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        {trip.dayLogs.map((dayLog) => (
                                            <Card
                                                key={dayLog.id}
                                                className="border-gold/20 bg-parchment-light"
                                            >
                        ...
                        <div className="space-y-6">
                            <Card className="border-gold/20 bg-parchment-light">
                                <CardHeader>
                                    <CardTitle className="text-lg text-deepbrown">
                                        Trip Statistics
                                    </CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-3">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-medium">
                                            {trip.countriesVisited?.length || 0}
                                        </span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-deepbrown/70">Daily Logs</span>
                                        <span className="font-medium">
                                            {trip.dayLogs?.length || 0}
                                        </span>
                                    </div>
                                    <div className="flex justify-between items-center">
