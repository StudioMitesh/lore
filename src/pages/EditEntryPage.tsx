                ...
                <main className="flex-1 pt-24 pb-16 flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <p className="text-deepbrown/70 mb-6">
                            The entry you're looking for doesn't exist or you don't have permission
                            to edit it.
                        </p>
                        <Button
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-deepbrown/70 mt-1">
                                    Update your adventure and memories
                                </p>
                            </div>
                        </div>
                        ...
                        {(associatedTrip || associatedDayLog) && (
                            <Card className="border-blue-200 bg-blue-50">
                                ...
                                <CardContent>
                                    {associatedTrip && (
                                        <div className="mb-2">
                                            <span className="font-medium text-blue-700">Trip:</span>{' '}
                                            {associatedTrip.name}
                                        </div>
                                    )}
                                    {associatedDayLog && (
                                ...
                                {existingImages.length > 0 || newImagePreviewUrls.length > 0 ? (
                                    <div className="space-y-6">
                                        {existingImages.length > 0 && (
                                            <div>
                                                <h4 className="text-sm font-medium text-deepbrown mb-3">
                                                    Current Photos
                                                </h4>
                                    ...
                                    <div className="border-2 border-dashed border-gold/30 rounded-lg p-8 text-center">
                                        ...
                                        <p className="text-deepbrown/70 mb-2">
                                            No photos added yet
                                        </p>
            ...
            <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you want to delete "{formData.title}"? This action cannot
                            be undone and will permanently remove the entry and all associated
                            photos.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
