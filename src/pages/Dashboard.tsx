                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          {getRecentEntries().map((entry, index) => (
                            <EntryCard
                              ...
                              imageUrl={
                                entry.mediaUrls[0] || '/placeholder.svg?height=400&width=600'
                              }
                              index={index}
                              type={entry.type}
                ...
                <TabsContent value="drafts" className="mt-6">
                  {draftEntries.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-deepbrown/70">Your saved drafts will appear here</p>
                    </div>
                  )}
                </TabsContent>
              </Tabs>
                  ...
                  <div className="space-y-3">
                    {getRecentLocations().map((entry) => (
                      ...
                      >
                        ...
                        <div className="text-gold/70">{getEntryIcon(entry.type)}</div>
                      </motion.div>
                    ))}
                  </div>
                </div>
