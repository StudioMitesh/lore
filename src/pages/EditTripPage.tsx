...
import { Save, ImageIcon, Calendar, X, Plus, Tag, ArrowLeft, Loader2, Trash2, Plane, Users, User } from "lucide-react"
...
export default function EditTripPage() {
  ...
  const handleRemoveCompanion = (companionToRemove: string) => {
    handleInputChange('companions', formData.companions.filter(companion => companion !== companionToRemove))
  }
  ...
  const currentCoverImage = newCoverImagePreview || (existingCoverImage && !removedCoverImage ? existingCoverImage : "")
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete "{formData.name}"? This action cannot be undone and will permanently remove the trip. All entries associated with this trip will become standalone entries.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button 
