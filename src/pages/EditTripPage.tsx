...
export default function EditTripPage() {
    ...
    const currentCoverImage =
        newCoverImagePreview ||
        (existingCoverImage && !removedCoverImage ? existingCoverImage : '');
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex gap-2">
                                    <Input
                                        ...
                                        onKeyPress={(e) =>
                                            e.key === 'Enter' && handleAddCompanion()
                                        }
                                    />
                                    <Button
                                        variant="outline"
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            undone and will permanently remove the trip. All entries associated with
                            this trip will become standalone entries.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
